...
# Hero has only 5 lives. If looses all the lives then the game is over.
...
for l in range(LIVES):
    ...
    while(running):
        ...
        if score >= EGG_TARGET:
            ...
            pygame.display.flip()
            time.sleep(3)
            ### DMG: -5. This makes the game break further below. 
            ###      What you want to do here is is set running = False
            ###      and l = LIVES + 1
            pygame.quit()
